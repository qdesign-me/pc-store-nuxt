<template>
  <main class="container">
    <div class="breadcrumbs"><NuxtLink to="/" class="">Главная </NuxtLink><span>Корзина</span></div>
    <h1>Корзина</h1>

    <div v-if="!Object.keys(items).length" class="flex flex-col items-center justify-center">
